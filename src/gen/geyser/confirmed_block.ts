...
export const ConfirmedBlock = {
  encode(message: ConfirmedBlock, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.parentSlot !== BigInt("0")) {
      writer.uint32(24).uint64(message.parentSlot.toString());
    }
  ...
  fromJSON(object: any): ConfirmedBlock {
    return {
      ...
      parentSlot: isSet(object.parentSlot) ? BigInt(object.parentSlot) : BigInt("0"),
  ...
  fromPartial<I extends Exact<DeepPartial<ConfirmedBlock>, I>>(object: I): ConfirmedBlock {
    ...
    message.parentSlot = object.parentSlot ?? BigInt("0");
...
export const TransactionStatusMeta = {
  encode(message: TransactionStatusMeta, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.computeUnitsConsumed !== undefined) {
      writer.uint32(128).uint64(message.computeUnitsConsumed.toString());
    }
    return writer;
  },
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          if ((tag & 7) === 2) {
            ...
            while (reader.pos < end2) {
              message.preBalances.push(longToBigint(reader.uint64() as Long));
            }
          } else {
            message.preBalances.push(longToBigint(reader.uint64() as Long));
          }
        ...
        case 4:
          if ((tag & 7) === 2) {
            const end2 = reader.uint32() + reader.pos;
            while (reader.pos < end2) {
              message.postBalances.push(longToBigint(reader.uint64() as Long));
            }
          } else {
            message.postBalances.push(longToBigint(reader.uint64() as Long));
          }
        ...
        case 15:
          ...
          break;
        case 16:
          message.computeUnitsConsumed = longToBigint(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): TransactionStatusMeta {
    return {
      ...
      preBalances: Array.isArray(object?.preBalances) ? object.preBalances.map((e: any) => BigInt(e)) : [],
      postBalances: Array.isArray(object?.postBalances) ? object.postBalances.map((e: any) => BigInt(e)) : [],
  ...
  toJSON(message: TransactionStatusMeta): unknown {
    ...
    message.computeUnitsConsumed !== undefined && (obj.computeUnitsConsumed = message.computeUnitsConsumed.toString());
    return obj;
  },
...
function createBaseReward(): Reward {
  return { pubkey: "", lamports: BigInt("0"), postBalance: BigInt("0"), rewardType: 0, commission: "" };
}
...
export const Reward = {
  encode(message: Reward, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.lamports !== BigInt("0")) {
      writer.uint32(16).int64(message.lamports.toString());
    }
    if (message.postBalance !== BigInt("0")) {
      writer.uint32(24).uint64(message.postBalance.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.lamports = longToBigint(reader.int64() as Long);
          break;
        case 3:
          message.postBalance = longToBigint(reader.uint64() as Long);
          break;
        case 4:
  ...
  fromJSON(object: any): Reward {
    return {
      ...
      postBalance: isSet(object.postBalance) ? BigInt(object.postBalance) : BigInt("0"),
  ...
  toJSON(message: Reward): unknown {
    ...
    message.postBalance !== undefined && (obj.postBalance = message.postBalance.toString());
  ...
  fromPartial<I extends Exact<DeepPartial<Reward>, I>>(object: I): Reward {
    ...
    message.postBalance = object.postBalance ?? BigInt("0");
...
export const UnixTimestamp = {
  ...
  fromJSON(object: any): UnixTimestamp {
    return { timestamp: isSet(object.timestamp) ? BigInt(object.timestamp) : BigInt("0") };
  },
...
export const BlockHeight = {
  ...
  fromJSON(object: any): BlockHeight {
    return { blockHeight: isSet(object.blockHeight) ? BigInt(object.blockHeight) : BigInt("0") };
  },
