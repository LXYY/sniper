...
export interface BlockUpdate {
  ...
  executedTransactionCount?: bigint | undefined;
...
export const PartialAccountUpdate = {
  encode(message: PartialAccountUpdate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.seq !== BigInt("0")) {
      writer.uint32(40).uint64(message.seq.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.seq = longToBigint(reader.uint64() as Long);
          break;
        case 6:
  ...
  fromJSON(object: any): PartialAccountUpdate {
    return {
      ...
      seq: isSet(object.seq) ? BigInt(object.seq) : BigInt("0"),
  ...
  toJSON(message: PartialAccountUpdate): unknown {
    ...
    message.seq !== undefined && (obj.seq = message.seq.toString());
  ...
  fromPartial<I extends Exact<DeepPartial<PartialAccountUpdate>, I>>(object: I): PartialAccountUpdate {
    ...
    message.seq = object.seq ?? BigInt("0");
...
export const AccountUpdate = {
  encode(message: AccountUpdate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.lamports !== BigInt("0")) {
      writer.uint32(24).uint64(message.lamports.toString());
    }
    if (message.owner.length !== 0) {
    ...
    if (message.rentEpoch !== BigInt("0")) {
      writer.uint32(48).uint64(message.rentEpoch.toString());
    }
    if (message.data.length !== 0) {
      writer.uint32(58).bytes(message.data);
    }
    if (message.seq !== BigInt("0")) {
      writer.uint32(64).uint64(message.seq.toString());
    }
    if (message.isStartup === true) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.lamports = longToBigint(reader.uint64() as Long);
          break;
        case 4:
          message.owner = reader.bytes();
          break;
        case 5:
          ...
          break;
        case 6:
          message.rentEpoch = longToBigint(reader.uint64() as Long);
          break;
        case 7:
  ...
  fromJSON(object: any): AccountUpdate {
    return {
      slot: isSet(object.slot) ? BigInt(object.slot) : BigInt("0"),
      pubkey: isSet(object.pubkey) ? bytesFromBase64(object.pubkey) : new Uint8Array(),
      lamports: isSet(object.lamports) ? BigInt(object.lamports) : BigInt("0"),
      owner: isSet(object.owner) ? bytesFromBase64(object.owner) : new Uint8Array(),
      isExecutable: isSet(object.isExecutable) ? Boolean(object.isExecutable) : false,
      rentEpoch: isSet(object.rentEpoch) ? BigInt(object.rentEpoch) : BigInt("0"),
  ...
  toJSON(message: AccountUpdate): unknown {
    ...
    message.pubkey !== undefined &&
      (obj.pubkey = base64FromBytes(message.pubkey !== undefined ? message.pubkey : new Uint8Array()));
    message.lamports !== undefined && (obj.lamports = message.lamports.toString());
    message.owner !== undefined &&
      (obj.owner = base64FromBytes(message.owner !== undefined ? message.owner : new Uint8Array()));
    message.isExecutable !== undefined && (obj.isExecutable = message.isExecutable);
    message.rentEpoch !== undefined && (obj.rentEpoch = message.rentEpoch.toString());
  ...
  fromPartial<I extends Exact<DeepPartial<AccountUpdate>, I>>(object: I): AccountUpdate {
    ...
    message.slot = object.slot ?? BigInt("0");
    message.pubkey = object.pubkey ?? new Uint8Array();
    message.lamports = object.lamports ?? BigInt("0");
    message.owner = object.owner ?? new Uint8Array();
    message.isExecutable = object.isExecutable ?? false;
    message.rentEpoch = object.rentEpoch ?? BigInt("0");
...
function createBaseSlotUpdate(): SlotUpdate {
  return { slot: BigInt("0"), parentSlot: undefined, status: 0 };
}
...
export const SlotUpdate = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.parentSlot = longToBigint(reader.uint64() as Long);
          break;
        case 3:
  ...
  toJSON(message: SlotUpdate): unknown {
    const obj: any = {};
    message.slot !== undefined && (obj.slot = message.slot.toString());
    message.parentSlot !== undefined && (obj.parentSlot = message.parentSlot.toString());
...
export const BlockUpdate = {
  encode(message: BlockUpdate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.executedTransactionCount !== undefined) {
      writer.uint32(48).uint64(message.executedTransactionCount.toString());
    }
    if (message.entryCount !== undefined) {
      writer.uint32(56).uint64(message.entryCount.toString());
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.executedTransactionCount = longToBigint(reader.uint64() as Long);
          break;
        case 7:
          message.entryCount = longToBigint(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): BlockUpdate {
    return {
      ...
      blockHeight: isSet(object.blockHeight) ? BigInt(object.blockHeight) : undefined,
      executedTransactionCount: isSet(object.executedTransactionCount)
        ? BigInt(object.executedTransactionCount)
        : undefined,
      entryCount: isSet(object.entryCount) ? BigInt(object.entryCount) : undefined,
    };
  },
  ...
  toJSON(message: BlockUpdate): unknown {
    ...
    message.blockHeight !== undefined && (obj.blockHeight = message.blockHeight.toString());
    message.executedTransactionCount !== undefined &&
      (obj.executedTransactionCount = message.executedTransactionCount.toString());
    message.entryCount !== undefined && (obj.entryCount = message.entryCount.toString());
    return obj;
  },
...
function createBaseTransactionUpdate(): TransactionUpdate {
  return { slot: BigInt("0"), signature: "", isVote: false, txIdx: BigInt("0"), tx: undefined };
}
...
export const TransactionUpdate = {
  encode(message: TransactionUpdate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.txIdx !== BigInt("0")) {
      writer.uint32(32).uint64(message.txIdx.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.txIdx = longToBigint(reader.uint64() as Long);
          break;
        case 5:
  ...
  toJSON(message: TransactionUpdate): unknown {
    ...
    message.txIdx !== undefined && (obj.txIdx = message.txIdx.toString());
...
function createBaseGetHeartbeatIntervalResponse(): GetHeartbeatIntervalResponse {
  return { heartbeatIntervalMs: BigInt("0") };
}
...
export const GetHeartbeatIntervalResponse = {
  encode(message: GetHeartbeatIntervalResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.heartbeatIntervalMs !== BigInt("0")) {
      writer.uint32(8).uint64(message.heartbeatIntervalMs.toString());
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetHeartbeatIntervalResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.heartbeatIntervalMs = longToBigint(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): GetHeartbeatIntervalResponse {
    return {
      heartbeatIntervalMs: isSet(object.heartbeatIntervalMs) ? BigInt(object.heartbeatIntervalMs) : BigInt("0"),
    };
  },

  toJSON(message: GetHeartbeatIntervalResponse): unknown {
    const obj: any = {};
    message.heartbeatIntervalMs !== undefined && (obj.heartbeatIntervalMs = message.heartbeatIntervalMs.toString());
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetHeartbeatIntervalResponse>, I>>(object: I): GetHeartbeatIntervalResponse {
    const message = createBaseGetHeartbeatIntervalResponse();
    message.heartbeatIntervalMs = object.heartbeatIntervalMs ?? BigInt("0");
    return message;
  },
};
